...
internal interface ZamanakCalendarOperations{
     ...
     * @return The current instance of [ZamanakCalendar].
     */
    fun getStartOfDay() : ZamanakCalendar

    /**
     * Sets the clock time to the end of the day (23:59:59).
     * @return The current instance of [ZamanakCalendar].
     */
    fun getEndOfDay() : ZamanakCalendar
     ...
     * @return The current instance of [ZamanakCalendar].
     */
    fun setClock(clock: Clock) : ZamanakCalendar
     ...
     * @return The current instance of [ZamanakCalendar].
     */
    fun setDateFromJalali(jalaliDate: JalaliDate) : ZamanakCalendar
     ...
     * @return The current instance of [ZamanakCalendar].
     */
    fun setDateFromGregorian(gregorianDate: GregorianDate) : ZamanakCalendar
     ...
     * @return The current instance of [ZamanakCalendar].
     */
    fun setDateFromTimeInMillis(time : Long) : ZamanakCalendar
     ...
     * @return The current instance of [ZamanakCalendar].
     */
    fun setTimeZone(timeZone: TimeZone) : ZamanakCalendar
     ...
     * @return The current instance of [ZamanakCalendar].
     */
    fun addDate(calendarType: CalendarType, timeUnitType: TimeUnitType, count : Int) : ZamanakCalendar
     ...
     * @return The current instance of [ZamanakCalendar].
     */
    fun subDate(calendarType: CalendarType, timeUnitType: TimeUnitType, count : Int) : ZamanakCalendar

    /**
     * Checks if this calendar is before the specified calendar.
     * @param zamanakCalendar The calendar to compare against.
     * @return True if this calendar is before the specified calendar; otherwise, false.
     */
    fun isBefore(zamanakCalendar: ZamanakCalendar) : Boolean
     ...
     */
    fun isAfter(zamanakCalendar: ZamanakCalendar) : Boolean
     ...
     */
    fun equalsDate(date: ZamanakCalendar) : Boolean
     ...
     * @return A list of [ZamanakCalendar] representing the weekdays of the current week.
     */
    fun getWeekdaysList() : List<ZamanakCalendar>
     ...
     * @return A list of [ZamanakCalendar] representing each day of the current month.
     */
    fun getMonthDaysList(calendarType: CalendarType) : List<ZamanakCalendar>
