...
class ZamanakCore() : ZamanakCalendarOperations {
    ...
    override fun addDate(
        calendarType: seyyed.ali.tabatabaei.zamanakCalendar.core.model.enums.CalendarType,
    ...
    private fun applyDateChange(
        ...
        when (timeUnitType) {
            ...
            TimeUnitType.HOUR -> {
                ...
                if (calendarType == seyyed.ali.tabatabaei.zamanakCalendar.core.model.enums.CalendarType.Jalali) {
                    val jDaysInMonth = seyyed.ali.tabatabaei.zamanakCalendar.core.utils.Constanse.jDaysInMonth.toMutableList().apply {
                    ...
                    val gDaysInMonth = seyyed.ali.tabatabaei.zamanakCalendar.core.utils.Constanse.gDaysInMonth.toMutableList().apply {
    ...
    override fun getMonthDaysList(calendarType: seyyed.ali.tabatabaei.zamanakCalendar.core.model.enums.CalendarType): List<ZamanakCore> {
        when(calendarType){
            seyyed.ali.tabatabaei.zamanakCalendar.core.model.enums.CalendarType.Gregorian -> {
            ...
            seyyed.ali.tabatabaei.zamanakCalendar.core.model.enums.CalendarType.Jalali -> {
